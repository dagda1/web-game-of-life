...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11708 = 0;while(true){
var m_11709 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11709 == null))
{} else
{m_11709.call(null);
if((count_11708 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11710 = (count_11708 + 1);
count_11708 = G__11710;
continue;
}
} else
{}
