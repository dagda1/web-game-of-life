...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_11673 = 0;while(true){
if((i_11673 < arr.length))
{(arr[i_11673] = null);
{
...
{var i_11680 = (self__.level + 1);while(true){
if((i_11680 <= (new_level + 1)))
{(update[i_11680] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_11682 = 0;while(true){
if((i_11682 <= self__.level))
{var links_11683 = (update[i_11682]).forward;if(((links_11683[i_11682]) === x__$1))
{(links_11683[i_11682] = (x__$1.forward[i_11682]));
{
var G__11684 = (i_11682 + 1);
i_11682 = G__11684;
continue;
}
} else
{{
var G__11685 = (i_11682 + 1);
i_11682 = G__11685;
continue;
}
}
