...
*/
cljs_http.util.build_url = (function build_url(p__9604){var map__9607 = p__9604;var map__9607__$1 = ((cljs.core.seq_QMARK_.call(null,map__9607))?cljs.core.apply.call(null,cljs.core.hash_map,map__9607):map__9607);var query_string = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"query-string","query-string",1183691816));var uri = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"uri","uri",1014020318));var server_port = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"server-port","server-port",4503998525));var server_name = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"server-name","server-name",4503925319));var scheme = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"scheme","scheme",4400883991));return [cljs.core.str((function (){var G__9608 = (new goog.Uri());G__9608.setScheme(cljs.core.name.call(null,(function (){var or__3443__auto__ = scheme;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return new cljs.core.Keyword(null,"http","http",1017117690);
}
})()));
G__9608.setDomain(server_name);
G__9608.setPort(server_port);
G__9608.setPath(uri);
G__9608.setQuery(query_string,true);
return G__9608;
})())].join('');
});
/**
...
cljs_http.util.parse_headers = (function parse_headers(headers){return cljs.core.reduce.call(null,(function (p1__9610_SHARP_,p2__9609_SHARP_){var vec__9612 = clojure.string.split.call(null,p2__9609_SHARP_,/:\s+/);var k = cljs.core.nth.call(null,vec__9612,0,null);var v = cljs.core.nth.call(null,vec__9612,1,null);if(cljs.core.truth_((function (){var or__3443__auto__ = clojure.string.blank_QMARK_.call(null,k);if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
...
{return cljs.core.assoc.call(null,p1__9610_SHARP_,clojure.string.lower_case.call(null,k),v);
}
