...
{{
var G__9588 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9588;
continue;
}
} else
...
{var pred__9592 = cljs.core._EQ_;var expr__9593 = limit;if(cljs.core.truth_(pred__9592.call(null,1,expr__9593)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__9592.call(null,2,expr__9593)))
...
var G__9595 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9596 = (limit__$1 - 1);
var G__9597 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9595;
limit__$1 = G__9596;
parts = G__9597;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___9599 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9599))
{var replacement_9600 = temp__4090__auto___9599;buffer.append([cljs.core.str(replacement_9600)].join(''));
} else
{buffer.append(ch);
}
{
